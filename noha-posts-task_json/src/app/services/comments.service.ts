...
export class CommentsService {
  ...
  editComment(comment, post_id): Observable<HttpResponse<Object>> {
    ...
    return this.http.put<HttpResponse<object>>(this.url + "/comments/" + commentObject.id, JSON.stringify(commentObject), this.httpOptions)
      .pipe(
        retry(1),
        catchError(this.errorHandler)
      );
  ...
  deleteComment(comment_id): Observable<HttpResponse<Object>> {
    ...
    return this.http.delete<HttpResponse<object>>(this.url + '/comments/' + comment_id, this.httpOptions)
      .pipe(
        retry(1),
        catchError(this.errorHandler)
      );
