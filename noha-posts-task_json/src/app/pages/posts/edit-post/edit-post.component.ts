...
export class EditPostComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.post.postName = this.postList.name;
    this.post.postDesc = this.postList.description;
    this.post.postAuthor = this.postList.author;
    this.post.post_brief_desc = this.postList.breif;
  }
